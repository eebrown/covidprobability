...
plot(incubation$x, adjust_pretest(0.13, incubation, 0.279), 
     ylab="Pre-test probability", xlab="Day")
lines(incubation$x, adjust_pretest(0.13, incubation, 0.279))
```
...
test <- individual_probability(test_day = 9, pre0 = 0.13, sens = sens, spec = 1, 
                               incubation = incubation, asymp = 0.279)
...
test_n <- unit_probability(test_day = 9, pre0 =  0.13, sens = sens, spec = 1, 
                           incubation = incubation, asympt = 0.279, n = 10)
